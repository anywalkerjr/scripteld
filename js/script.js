...
$(document).ready(function($) {
	...
	if (currentUser != undefined) {
		...
		$('header').html(
			'    <div class="hburgerMenuIcon"><div id="stick1" class="stickHburger"></div><div id="stick2" class="stickHburger"></div><div id="stick3" class="stickHburger"></div></div><h2>scripteld</h2></a><div class="profileIn"><a href="postCreating.html"><input type="button" class="postMake" value="Publish"></a><img class="notification" style="position: relative;" src="images/icon_notification.svg"><h3><a href="profile.html">' +
				names +
